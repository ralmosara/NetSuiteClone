...
const navigation = [
  ...
  { name: "Pay Stubs", href: "/employee/paystubs", icon: "receipt" },
  { name: "Time Off", href: "/employee/time-off", icon: "event_available" },
  { name: "Benefits", href: "/employee/benefits", icon: "health_and_safety" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-bold text-slate-900 dark:text-white">Employee Portal</span>
                <p className="text-xs text-muted-foreground">Self-Service Center</p>
              </div>
            </div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-2">
                  <Avatar className="h-8 w-8">
                    <AvatarFallback className="bg-primary text-white text-sm">AM</AvatarFallback>
                  </Avatar>
                  <span className="hidden sm:block">Alex Morgan</span>
              ...
              <DropdownMenuContent align="end" className="w-56">
                <div className="px-3 py-2">
                  ...
                  <p className="text-sm text-muted-foreground">alex.morgan@company.com</p>
                </div>
                <DropdownMenuSeparator />
                <DropdownMenuItem>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="#" className="hover:text-primary">Employee Handbook</a>
              <a href="#" className="hover:text-primary">IT Support</a>
            </div>
          </div>
        </div>
      </footer>
